                ...
                <div class="flex items-stretch justify-center overflow-hidden bg-white shadow-xs xl:rounded-xl">
                    ...
                    <div class="flex flex-col">
                        <div class="flex h-full">
                            <div class="relative flex flex-col items-start justify-start hidden w-full h-full max-w-xs bg-center bg-cover lg:block" style="background-image:url('storage/settings/May2021/images/mockup-image-01.jpg')">
                                <div class="relative flex flex-col items-start justify-center w-full h-full px-16 py-8">

                                    <img src="storage/settings/May2021/images/tiktoklogo.svg" class="z-20 w-auto h-10">
                                    <h3 class="z-30 mt-1 mt-3 text-lg font-thin text-wave-200">The Software Platform for Brands and Creators.</h3>

                                    <span class="relative z-20 inline-flex mt-5 rounded-md shadow-sm">
                                        <a href="https://airmint.us" class="relative inline-flex items-center px-4 py-2 text-sm font-medium leading-5 transition duration-150 ease-in-out bg-white border border-transparent rounded-md text-wave-500 hover:bg-gray-100 focus:outline-none focus:border-gray-300 focus:shadow-outline-gray active:bg-gray-100">
                                            Get AirMint Today
                                            <!-- <span class="absolute top-0 right-0 px-3 py-1 -mt-4 -mr-8 text-xs text-white rounded-full bg-wave-400">Version 2</span> -->
                                        </a>
                                    </span>
                                </div>
                                <div class="absolute inset-0 w-full h-full opacity-60 bg-wave-600"></div>
                                <div class="absolute inset-0 w-full h-full opacity-60 bg-gradient-to-br from-wave-600 to-red-600"></div>
                            </div>
                            <div class="relative z-20 grid gap-6 px-5 pt-6 pb-8 bg-white border-t border-b border-transparent xl:border-gray-200 sm:gap-8 sm:p-8">
                                <a href="#" class="flex items-start inline-block p-3 -m-3 space-x-4 transition duration-150 ease-in-out rounded-lg group">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        Campaign Creation – Create an Account, Dropdown Inquiry
                                        </p>
                                    </div>
                                </a>
                                <a href="#" class="flex items-start inline-block p-3 -m-3 space-x-4 transition duration-150 ease-in-out rounded-lg group">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <p class="text-sm leading-5 text-gray-500">
                                        Monetization Center - On Chain Sales, Revenue & Cost Tracking, KPI Tracking, AI Models, Exchange Integration.
                                        </p>
                                    </div>
                                </a>
                                <a href="#" class="flex items-start inline-block p-3 -m-3 space-x-4 transition duration-150 ease-in-out rounded-lg group">
                                ...
                                <a href="#" class="flex items-start inline-block p-3 -m-3 space-x-4 transition duration-150 ease-in-out rounded-lg group">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <p class="text-sm leading-5 text-gray-500">
                                        Available Rewards and Campaigns, video content.
                                        </p>
                                    </div>
                                </a>
                            ...
                            <a href="#" class="flex items-start inline-block p-3 -m-3 space-x-4 transition duration-150 ease-in-out rounded-lg group">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <p class="text-sm leading-5 text-gray-500">
                                    Passport, Portfolio, Estimated Earned Value, Administrative, Analytics.
                                    </p>
                                </div>
                            </a>
                            <a href="#" class="flex items-start inline-block p-3 -m-3 space-x-4 transition duration-150 ease-in-out rounded-lg group">
                            ...
                            <a href="#" class="flex items-start inline-block p-3 -m-3 space-x-4 transition duration-150 ease-in-out rounded-lg group">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <p class="text-sm leading-5 text-gray-500">
                                        Leaderboards, level-ups, and so much more.
                                    </p>
                                </div>
                            </a>
                            <a href="#" class="flex items-start inline-block p-3 -m-3 space-x-4 transition duration-150 ease-in-out rounded-lg group">
            ...
            <div class="shadow-lg rounded-xl">
                <div class="overflow-hidden border border-gray-100 shadow-md rounded-xl">
                    <div class="relative z-20 grid bg-white">
                        <a href="#" class="flex items-start p-10 -m-3 space-x-3 transition duration-150 ease-in-out rounded-lg pb-7 group">
                        ...
                        <a href="#" target="_blank" class="flex items-start px-10 -m-3 space-x-3 transition duration-150 ease-in-out rounded-lg py-7 group">
